    ...
    <div class="package-card">
      ...
      <div class="package-details">
        <div class="detail-item">
          <label>From</label>
          <span>${pkg.sender || 'N/A'}</span>
        </div>
        <div class="detail-item">
          <label>To</label>
          <span>${pkg.recipientName || pkg.recipient || 'N/A'}</span>
        </div>
        <div class="detail-item">
        ...
        <div class="detail-item">
          <label>Weight</label>
          <span>⚖️ ${pkg.weight || 'N/A'}</span>
        </div>
        <div class="detail-item">
          <label>Est. Delivery</label>
          <span>📅 ${pkg.estimatedDelivery || 'TBD'}</span>
        </div>
        <div class="detail-item">
          <label>Delivered By</label>
          <span>🐾 ${pkg.deliveredBy || 'Beertjie'}</span>
        </div>
        <div class="detail-item">
          <label>Description</label>
          <span>${pkg.description || 'N/A'}</span>
        </div>
        <div class="detail-item">
...
function openDiscord() {
  window.open('https://discord.gg/fcUTg5ay6n', '_blank');
}
